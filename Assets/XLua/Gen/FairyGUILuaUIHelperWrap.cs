...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUILuaUIHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.LuaUIHelper);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.LuaUIHelper gen_ret = new FairyGUI.LuaUIHelper();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.LuaUIHelper constructor!");
